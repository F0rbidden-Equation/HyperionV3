...
class Controller:
    ...
    def Report_DDOS(self):
        ...
        if verifdns == True:
            ...
            time.sleep(2)
            mpb.update()
            subprocess.call("nmap -p80 --script http-slowloris  " + dns + " -oX Extra_Analyse.xml ",shell=True, stdout=subprocess.DEVNULL)
            mpb["value"] = 50
            time.sleep(3)
            mpb.update()
            subprocess.call("xsltproc Extra_Analyse.xml -o Extra_Analyse.html", shell=True, stdout=subprocess.DEVNULL)
    ...
    def Report_SMB_vulnerabilitie(self):
        ...
        if verifdns == True:
            ...
            time.sleep(3)
            mpb.update()
            subprocess.call("nmap --script smb-check-vulns -p445 " + dns + " -oX Extra_Analyse.xml ", shell=True,
                            stdout=subprocess.DEVNULL)
            subprocess.call("xsltproc Extra_Analyse.xml -o Extra_Analyse.html", shell=True, stdout=subprocess.DEVNULL)
            f = open('Extra_Analyse.html', 'r')
            html_string = f.read()
