...
from PyQt5 import QtCore, QtGui, QtWidgets
from PyQt5 import QtWebEngineWidgets  # Attention Qwebview remplacé par webEngineView !!!
from PyQt5.QtCore import Qt
import socket
import os
import webbrowser
import back1_hyperion
import Back2_dns
import pdfkit  # pip3 install pdfkit , sudo apt-get install wkhtmltopdf
import subprocess
import shutil
import dns.resolver  #python3 ubuntu
import nmap3
import json
import dns_error_qrc
from colorama import init
from termcolor import colored       #pip3 install colorama termcolor
from tkinter import ttk             #sudo apt-get install python3-tk
from tkinter import *
import time
...
import matplotlib.image as mpimg   #pip3 install matplotlib
...
import pandas as pd #pip3 install panda
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(737, 330)
        MainWindow.setFixedSize(737, 330) #fixé

        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../../.designer/Hyperion3_pret/recovery.png"), QtGui.QIcon.Normal,
                       QtGui.QIcon.Off)
        MainWindow.setWindowIcon(icon)
        MainWindow.setStyleSheet("background-color: rgb(0, 0, 0);\n"
                                 "\n"
                                 "selection-color: rgb(250, 71, 71);\n"
        ...
        self.label.setGeometry(QtCore.QRect(0, 150, 741, 131))
        self.label.setStyleSheet("image: url(:/newPrefix/Hyperion_red2.jpg);")
        self.label.setText("")
        ...
        self.menuRecovery_Infos = QtWidgets.QMenu(self.menubar)
        self.menuRecovery_Infos.setObjectName("menuRecovery_Infos")
        self.menuWeb_DataBase = QtWidgets.QMenu(self.menubar)
        self.menuWeb_DataBase.setObjectName("menuWeb_DataBase")
        self.menuWeb_Vunerability = QtWidgets.QMenu(self.menubar)
        self.menuWeb_Vunerability.setObjectName("menuWeb_Vunerability")
        self.menuAttack_Network = QtWidgets.QMenu(self.menubar)
        self.menuAttack_Network.setObjectName("menuAttack_Network")
        self.Admin_Panel = QtWidgets.QMenu(self.menubar)
        ...
        self.actionEnumerations_Hote = QtWidgets.QAction(MainWindow)
        self.actionEnumerations_Hote.setObjectName("actionEnumerations_Hote")
        self.actionScraping_email = QtWidgets.QAction(MainWindow)
        self.actionScraping_email.setObjectName("actionScraping_email")
        self.actionSMB = QtWidgets.QAction(MainWindow)
        self.actionSMB.setObjectName("actionSMB")
        ...
        self.actiontheharvester = QtWidgets.QAction(MainWindow)
        self.actiontheharvester.setObjectName("theharvester")
        ######################### DB #################################
        ...
        self.actionDDOS_scanner = QtWidgets.QAction(MainWindow)
        self.actionDDOS_scanner.setObjectName("actionDDOS_scanner")
        ...
        self.actionSMB_vuln = QtWidgets.QAction(MainWindow)
        self.actionSMB_vuln.setObjectName("actionSMB_vuln")
        self.actionSSL_inject = QtWidgets.QAction(MainWindow)
        self.actionSSL_inject.setObjectName("actionSSL_inject")
        self.actionnikto = QtWidgets.QAction(MainWindow)
        self.actionnikto.setObjectName("actionnikto")
        ...
        ############## sous Menu ###################################################
        self.menubar.addAction(self.menuRecovery_Infos.menuAction())
        self.menuRecovery_Infos.addAction(self.actionInfos_DNS)
        self.menuRecovery_Infos.addAction(self.actionDNS_Champs_MX)
        self.menuRecovery_Infos.addAction(self.actionHote_IP)
        self.menuRecovery_Infos.addAction(self.actionRoute_Tcp)
        self.menuRecovery_Infos.addAction(self.actionInfos_SearchEngins)
        self.menuRecovery_Infos.addAction(self.actionEnumerations_Hote)
        self.menuRecovery_Infos.addAction(self.actionScraping_email)
        self.menuRecovery_Infos.addAction(self.actionSMB)
        self.menuRecovery_Infos.addAction(self.actionDiscovering_interesting)
        self.menuRecovery_Infos.addAction(self.actionmod_userdir)
        self.menuRecovery_Infos.addAction(self.actionDetecting_SMTP)
        self.menuRecovery_Infos.addAction(self.actionEnumerating_SMTP)
        self.menuRecovery_Infos.addAction(self.actionIMAP)
        self.menuRecovery_Infos.addAction(self.actionPOP3)
        self.menuRecovery_Infos.addAction(self.actionNTLM_SMTP)
        self.menuRecovery_Infos.addAction(self.actiontheharvester)
        #################### Menu DataBase ############################################
        self.menubar.addAction(self.menuWeb_DataBase.menuAction())
        self.menuWeb_DataBase.addAction(self.actionscan_DB)
        self.menuWeb_DataBase.addAction(self.actionempty_MYSQL)
        self.menuWeb_DataBase.addAction(self.actionlistall_MYSQL)
        self.menuWeb_DataBase.addAction(self.actioninfo_msssql)
        self.menuWeb_DataBase.addAction(self.actioninfo_mongodb)
        self.menuWeb_DataBase.addAction(self.actionDetecting_MongoDB)
        self.menuWeb_DataBase.addAction(self.actionList_CoucheDB)
        self.menuWeb_DataBase.addAction(self.actionstatic_CoucheDB)

        ################ Vulnerabilities #############################
        self.menubar.addAction(self.menuWeb_Vunerability.menuAction())
        self.menuWeb_Vunerability.addAction(self.actioncve_scanner)
        self.menuWeb_Vunerability.addAction(self.actionXSS_scanner)
        self.menuWeb_Vunerability.addAction(self.actionDDOS_scanner)
        self.menuWeb_Vunerability.addAction(self.actionSQL_scanner)
        self.menuWeb_Vunerability.addAction(self.actionweb_applications)
        self.menuWeb_Vunerability.addAction(self.actionShellshock)
        self.menuWeb_Vunerability.addAction(self.actioninsecure_crossdomain)
        self.menuWeb_Vunerability.addAction(self.actionsourcecode_control)
        self.menuWeb_Vunerability.addAction(self.actionInsecureCipherSSL)
        self.menuWeb_Vunerability.addAction(self.actionCSRF)
        self.menuWeb_Vunerability.addAction(self.actionRFI)
        self.menuWeb_Vunerability.addAction(self.actionSMB_vuln)
        self.menuWeb_Vunerability.addAction(self.actionSSL_inject)
        self.menuWeb_Vunerability.addAction(self.actionnikto)
        ############## FireWALL ##########################
        self.menubar.addAction(self.menuAttack_Network.menuAction())
        self.menuAttack_Network.addAction(self.actionWafw00f)
        self.menuAttack_Network.addAction(self.actionwaf_http)
        self.menuAttack_Network.addAction(self.actionwaf_detect)
        self.menuAttack_Network.addAction(self.actionwaf_fingerprint)

        ############ Brute Force Menu ########################
        self.menubar.addAction(self.Admin_Panel.menuAction())
        self.Admin_Panel.addAction(self.actionmenulogin)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuRecovery_Infos.setTitle(_translate("MainWindow", "Recovery_Infos"))
        self.menuWeb_DataBase.setTitle(_translate("MainWindow", "Web_DataBase"))
        self.menuWeb_Vunerability.setTitle(_translate("MainWindow", "Web_Vunerability"))
        self.menuAttack_Network.setTitle(_translate("MainWindow", "Firewall_Infos"))
        self.Admin_Panel.setTitle(_translate("MainWindow", "Admin_Panel"))

        self.menuQuit.setTitle(_translate("MainWindow", "Quit"))
        self.actionInfos_DNS.setText(_translate("MainWindow", "General "))

        self.actionDNS_Champs_MX.setText(_translate("MainWindow", "Network "))
        self.actionHote_IP.setText(_translate("MainWindow", "Geolocation "))
        self.actionRoute_Tcp.setText(_translate("MainWindow", "Advanced "))
        self.actionInfos_SearchEngins.setText(_translate("MainWindow", "Listing supported HTTP methods"))
        self.actionEnumerations_Hote.setText(_translate("MainWindow", "Network_Advanced"))
        self.actionScraping_email.setText(_translate("MainWindow", "Scraping email"))
        self.actionSMB.setText(_translate("MainWindow", "SMB"))
        ...
        self.actiontheharvester.setText(_translate("MainWindow", "The_Harvester"))
        ################ Firewall sous Menu name #############################
        ...
        ################ vulnerabilties sous Menu name #############################
        self.actioncve_scanner.setText(_translate("MainWindow", "CVE Scan "))
        self.actionXSS_scanner.setText(_translate("MainWindow", "XSS Scan "))
        self.actionSQL_scanner.setText(_translate("MainWindow", "SQL Scan"))
        self.actionDDOS_scanner.setText(_translate("MainWindow", "DDOS Scan"))
        self.actionweb_applications.setText(_translate("MainWindow", "web_applications Scan"))
        self.actionShellshock.setText(_translate("MainWindow", "Shellshock Scan"))
        self.actioninsecure_crossdomain.setText(_translate("MainWindow", "insecure crossdomain Scan"))
        self.actionsourcecode_control.setText(_translate("MainWindow", "sourcecode control Scan"))
        self.actionInsecureCipherSSL.setText(_translate("MainWindow", "InsecureCipherSSL"))
        self.actionCSRF.setText(_translate("MainWindow", "CSRF"))
        self.actionRFI.setText(_translate("MainWindow", "RFI"))
        self.actionSMB_vuln.setText(_translate("MainWindow", "SMB vulnerabilitie"))
        self.actionSSL_inject.setText(_translate("MainWindow", "SSL Injection"))
        self.actionnikto.setText(_translate("MainWindow", "scan Multiple Nikto"))
        ################ brute force sous Menu name #############################
...
class Ui_Dialog_dns(object):
    ...
    def retranslateUi(self, Dialog_dns):
        _translate = QtCore.QCoreApplication.translate
        Dialog_dns.setWindowTitle(_translate("Dialog", "Dialog"))
...
class Ui_Dialog_error_dns(object):
    def setupUi_error_dns(self, Dialog_error_dns):
        ...
        # flags = Qt.WindowFlags() #retiré le bouton close
        # Dialog_error_dns.setWindowFlags(flags)
        # Dialog_error_dns.setWindowFlags(Qt.WindowCloseButtonHint, False)
        # Dialog_error_dns.setWindowFlags(QtCore.Qt.WindowMinimizeButtonHint)
        # Dialog_error_dns.setWindowFlags(QtCore.Qt.WindowCloseButtonHint)
        # Dialog_error_dns.setWindowFlags(QtCore.Qt.CustomizeWindowHint)
    ...
    def retranslateUi(self, Dialog_error_dns):
        _translate = QtCore.QCoreApplication.translate
        Dialog_error_dns.setWindowTitle(_translate("Dialog", "Dialog"))
        self.label.setText(_translate("Dialog",
...
class Ui_Dialog_report(object):  # dialog html GUI # whois report
    def setupUi(self, Dialog_report):
        ...
        Dialog_report.resize(957, 715)
        Dialog_report.setStyleSheet("background-color: rgb(0, 0, 0);")
        self.webEngineView = QtWebEngineWidgets.QWebEngineView(Dialog_report)
        self.webEngineView.setGeometry(QtCore.QRect(-1, 0, 957, 715))
...
class Ui_Dialog_report_champsMX(object):  # dialog html GUI
    def setupUi(self, Dialog_report_champsMX):
        Dialog_report_champsMX.setObjectName("Hyperion network DNS")
        Dialog_report_champsMX.resize(1100, 315)
        Dialog_report_champsMX.setStyleSheet("background-color: rgb(0, 0, 0);")
        self.webEngineView = QtWebEngineWidgets.QWebEngineView(Dialog_report_champsMX)
        self.webEngineView.setGeometry(QtCore.QRect(-1, 0, 1100, 315)) # 315 hauteur #957 largeur 
        self.webEngineView.setCursor(QtGui.QCursor(QtCore.Qt.ArrowCursor))
        # self.webEngineView.setUrl(QtCore.QUrl())
        # self.webEngineView .setObjectName("webView")
        self.webEngineView.setStyleSheet("width: 50%")
        current_dir = os.path.dirname(os.path.realpath(__file__))
...
class Controller:
    ...
    def voir_Menu_general(self):
        ...
        self.ui.actionEnumerations_Hote.triggered.connect(self.voir_Menu_network_advanced)  ### ATTENTION
        self.ui.actionScraping_email.triggered.connect(self.voir_Menu_networt_scrapping_email)
        self.ui.actionSMB.triggered.connect(self.voir_Menu_network_SMB)
        ...
        self.ui.actionDetecting_SMTP.triggered.connect(self.voir_Menu_network_mod_userdir)
        ...
        self.ui.actiontheharvester.triggered.connect(self.voir_Menu_network_the_harvester)
        #######################################################################################################
        ...
        self.ui.actionDDOS_scanner.triggered.connect(self.voir_Menu_Report_DDOS_Scan)
        ...
        self.ui.actionSMB_vuln.triggered.connect(self.voir_Menu_Report_SMB_vulnerabilitie)
        self.ui.actionSSL_inject.triggered.connect(self.voir_Menu_Report_SSL_Injection)
        self.ui.actionnikto.triggered.connect(self.voir_Menu_Report_Nikto)
        #####################################################################################################
        ...
        self.ui.actionList_CoucheDB.triggered.connect(self.voir_Menu_network_infos_mongodb)
        self.ui.actionstatic_CoucheDB.triggered.connect(self.voir_Menu_network_detecting_mongodb)
    ...
    def voir_Menu_Login_PHP(self, Dialog_dns):
        self.Dialog_dns = QtWidgets.QDialog()
        self.ui = Ui_Dialog_dns()
        self.ui.setupUi(self.Dialog_dns)
        self.Dialog_dns.show()
    ...
    def voir_Menu_Login_BRF(self, Dialog_dns):
        self.Dialog_dns = QtWidgets.QDialog()
        self.ui = Ui_Dialog_dns()
        self.ui.setupUi(self.Dialog_dns)
        self.Dialog_dns.show()
    ...
    def voir_Menu_Login_ASP(self, Dialog_dns):
        self.Dialog_dns = QtWidgets.QDialog()
        self.ui = Ui_Dialog_dns()
        self.ui.setupUi(self.Dialog_dns)
        self.Dialog_dns.show()
    ...
    def voir_Menu_Login_CFM(self, Dialog_dns):
        self.Dialog_dns = QtWidgets.QDialog()
        self.ui = Ui_Dialog_dns()
        self.ui.setupUi(self.Dialog_dns)
        self.Dialog_dns.show()
    ...
    def voir_Menu_Login_JS(self, Dialog_dns):
        self.Dialog_dns = QtWidgets.QDialog()
        self.ui = Ui_Dialog_dns()
        self.ui.setupUi(self.Dialog_dns)
        self.Dialog_dns.show()
    ...
    def voir_Menu_Login_CGI(self, Dialog_dns):
        self.Dialog_dns = QtWidgets.QDialog()
        self.ui = Ui_Dialog_dns()
        self.ui.setupUi(self.Dialog_dns)
        self.Dialog_dns.show()
    ...
    def Report_DNS_General(self, Dialog_pdf):
        ...
        if os.path.exists("template.html"):
            ...
            pass
        import os
        print(colored("[Welcome on the report General Informations] ",'magenta'))
        ...
        if verifdns == True:
            ...
            print((colored("|--> Starting Analyse General Informations DNS :", 'green')), dns)
            ...
            message = """<html>
                            ...
                            <center>
                            <p style="color: black;font-size:30px;text-shadow: 1px 1px 1px red,2px 2px 1px red";><span style="text-decoration: underline;"><B>Report DNS Analyse General</B><p>
                            </center>
                            <p style="color: black;font-size:20px;text-shadow: 1px 1px 1px red,2px 2px 1px red";><span><B>Informations General on the DNS :</B><p>
                            <body><p><span style="color: red"><B>DNS Ip Adress : </span><span class="macouleur2">{IP}</B></span></p></body>
                            <body><p><span style="color: red"><B>DNS target : </span><span class="macouleur2">{TARGET}</B></span></p></body>
                            <body><p><span style="color: red"><B>DNS registar : </span><span class="macouleur2">{REGISTRAR}</B></span></p></body>
                            <body><p><span style="color: red"><B>DNS Whois_Server : </span><span class="macouleur3">{WHOIS_SERVER}</B></span></p></body>
                            <body><p><span style="color: red"><B>DNS referral_url : </span><span class="macouleur3">{REFERRAL_URL}</B></span></p></body>
                            <body><p><span style="color: red"><B>DNS last_updated : </span><span class="macouleur3">{LAST_UPDATED}</B></span></p></body>
                            <body><p><span style="color: red"><B>DNS Creation_date : </span><span class="macouleur3">{CREATION}</B></span></p></body>
                            <body><p><span style="color: red"><B>DNS expiration_date : </span><span class="macouleur3">{EXPIRATION}</B></span></p></body>
                            <body><p><span style="color: red"><B>DNS Name_Servers : </span><span class="macouleur3">{NAME_SERVERS}</B></span></p></body>
                            <body><p><span style="color: red"><B>DNS status : </span><span class="macouleur3">{STATUS}</B></span></p></body>
                            <body><p><span style="color: red"><B>DNS Emails : </span><span class="macouleur3">{EMAILS}</B></span></p></body>
                            <body><p><span style="color: red"><B>DNS_secondary : </span><span class="macouleur3">{DNSSEC}</B></span></p></body>
                            <body><p><span style="color: red"><B>DNS Name : </span><span class="macouleur3">{NAME}</B></span></p></body>
                            <body><p><span style="color: red"><B>DNS Organisation : </span><span class="macouleur3">{ORGANISATION}</B></span></p></body>
                            <body><p><span style="color: red"><B>DNS Adress : </span><span class="macouleur3">{ADRESS}</B></span></p></body>
                            <body><p><span style="color: red"><B>DNS City : </span><span class="macouleur3">{CITY}</B></span></p></body>
                            <body><p><span style="color: red"><B>DNS State : </span><span class="macouleur3">{STATE}</B></span></p></body>
                            <body><p><span style="color: red"><B>DNS Zip_Code : </span><span class="macouleur3">{ZIPCODE}</B></span></p></body>
                            <body><p><span style="color: red"><B>DNS Country : </span><span class="macouleur3">{COUNTRY}</B></span></p></body>
                            <p style="color: black;font-size:20px;text-shadow: 1px 1px 1px red,2px 2px 1px red";><span><B> Informations Server Secondary : </B><p>
                            <body><p><span style="color: red"><B> DNS Versions Server : </B></span><span class="macouleur3">{SERVER}</span></p></body
                            </html>""".format(
                IP=ip,
                TARGET=domain,
                REGISTRAR=regis,
            ...
            f.write(bytes)
            f.close()
            print(colored("[*] Scanning and report [General Informations] finished with Sucessfull ", 'magenta'))
            print(colored("-----------------------------------------------------------------------------------",'blue'))
            print("")
    ...
    def Report_DNS_Network(self):
        ...
        if verifdns == True:
            ...
            LTS_A = []
            try:
                for x in dns.resolver.query(dns1, 'A'):
                    A = ([LTS_A.append(x.to_text())])
                    tableau_A = (tabulate([[a] for a in LTS_A], tablefmt='html'))
                    ...
                    nx.draw_networkx_nodes(G, pos, node_size=120, node_shape='d', node_color='red')
                    ...
                    plt.savefig('grah_A.jpg')
                message_A = """<html>
                                   <head></head>
                                   <center>
                                   <p style="color: black;font-size:20px;text-shadow: 1px 1px 1px red,2px 2px 1px red";><span style="text-decoration: underline;"><B>Mapping Network : Servers Datas ipv4 (A)  </B><p>
                                   </center>
                                   <center>
                                   <img src="grah_A.jpg">
                                   </center>
            ...
            LTS_AAAA = []
            try:
                for x in dns.resolver.query(dns1, 'AAAA'):
                    AAAA = ([LTS_AAAA.append(x.to_text())])
                    tableau_AAAA = (tabulate([[aaaa] for aaaa in LTS_AAAA], tablefmt='html'))
                    import networkx as nx
                    import matplotlib.pyplot as plt
                    import matplotlib as mpl
                    import pylab
                    ...
                    nx.draw_networkx_edges(G, pos, edge_color='black')
                    limits = plt.axis('off')  # RETIRÉ LE CADRE lIMIT
                    plt.savefig('grah_AAAA.jpg')
                message_AAAA = """<html>
                                      <head></head>
                                      <center>
                                      <p style="color: black;font-size:20px;text-shadow: 1px 1px 1px red,2px 2px 1px red";><span style="text-decoration: underline;"><B>Mapping Network : Servers Datas ipv6 (AAAA)  </B><p>
                                      </center>
                                      <center>
                                      <img src="grah_AAAA.jpg">
                                      </center>
            ...
            LTS_mx = []
            try:
                for x in dns.resolver.query(dns1, 'MX'):
                ...
                message_MX = """<html>
                                    <head></head>
                                    <center>
                                    <p style="color: black;font-size:20px;text-shadow: 1px 1px 1px red,2px 2px 1px red";><span style="text-decoration: underline;"><B>Mapping Network : Servers Datas Email (MX)  </B><p>
                                    </center>
                                    <center>
                                    <img src="grah_MX.jpg">
                                    </center>
            ...
            html = df.to_html().replace('<th>', '<th style = "color: red">')
            mpb["value"] = 90
            mpb.update()
            from tabulate import tabulate
            ...
            for item in subdomains_list:
                ...
                limits = plt.axis('off')  # RETIRÉ LE CADRE lIMIT
                # plt.show()
                plt.savefig('grah_subdomain.jpg')
            message_sub = """<html>
                                <head></head>
                                <center>
                                <p style="color: black;font-size:20px;text-shadow: 1px 1px 1px red,2px 2px 1px red";><span style="text-decoration: underline;"><B>Mapping Network : Servers Datas Subdomains  </B><p>
                                </center>
                                <center>
                                <img src="grah_subdomain.jpg">
                                </center>
            ...
            self.ui.lineEdit.textChanged[str].connect(lambda: self.ui.pushButton_2.setEnabled(self.ui.lineEdit.text() != ""))
    ...
    def Report_DNS_Geolocation(self):
        ...
        if verifdns == True:
            ...
            html1 = df1.to_html().replace('<th>', '<th style = "color: black">').replace('<td>',
            ...
            message1 = """<html>
                          ...
                          <center>
                          <p style="color: black;font-size:30px;text-shadow: 1px 1px 1px red,2px 2px 1px red";><span style="text-decoration: underline;"><B>Informations Geolocations Mapping Servers</B><p>
                          <center>
                          <body><p><span style="color: black"><B>DNS Target : </span><span style="color: green" class="macouleur2">{TARGET}</B></span></p></body>
                          <center>
                          <p style="color: black;font-size:30px;text-shadow: 1px 1px 1px red,2px 2px 1px red";><span style="text-decoration: underline;"><B>Informations Geolocations Mapping Type Servers IPv4 DNS</B><p>
                          <iframe src=maCarte_GPStest.html width=1200 height=450></iframe>
                          <center>
                          <center>
                          <img src="dns.png" width=50 height=50 />
                          </center>
            ...
            html2 = df2.to_html(justify="center").replace('<th>', '<th style = "color: black">').replace('<td>',
                                                                                                         '<td style = "color: green">')
            ...
            for item in locationlist2:
                folium.Marker(location=item, popup=popup_dns2,
                              tooltip='<p style="color:#FF0000";>* Informations Servers * click <p>',
                              icon=folium.features.CustomIcon('dns2.png', icon_size=(30, 30))).add_to(c2)
                pass
            ...
            c2.save('maCarte_GPStest2.html')

            message2 = """<html>
                          <head></head>
                          <center>
                          <p style="color: black;font-size:30px;text-shadow: 1px 1px 1px red,2px 2px 1px red";><span style="text-decoration: underline;"><B>Informations Geolocations Mapping Type Servers NS</B><p>
                          <iframe src=maCarte_GPStest2.html width=1200 height=450></iframe>
                          <center>
                          <center>
                          <img src="dns2.png" width=50 height=50 />
                          </center>
            ...
            LTS_mx = []
            try:
                answer_MX = dns.resolver.query(n, 'MX')
            except dns.resolver.NoAnswer:
                print(colored("[!] No MX record ",'red'))
                no_RE_MX = ("No MX record : " + dns1)
                message_No_MX = """<html>
                                   <head></head>
                                   <body><p><span class="macouleur2"><B>{NO_RE_MX}</B></span></p></body>
                                   </html>""".format(
                ...
                for rdata in answer_MX:
                    MX = (rdata.exchange.to_text())
                    LTS_mx.append(MX)
                    pass
                list_ip_MX = []
                for item in LTS_mx:
                    addr_MX = socket.gethostbyname(item)
                    list_ip_MX.append(addr_MX)
                    pass
                ...
                List_lat_MX = []
                List_lon_MX = []
                for item in list_ip_MX:
                    response_MX = DbIpCity.get(item, api_key='free')
                    List_city_MX.append(response_MX.city)
                    List_region_MX.append(response_MX.region)
                    List_country_MX.append(response_MX.country)
                    List_lat_MX.append(response_MX.latitude)
                    List_lon_MX.append(response_MX.longitude)
                    pass
                df_MX = pd.DataFrame(
                    {'Servers DNS': LTS_mx, 'Address': list_ip_MX, 'city': List_city_MX, 'region': List_region_MX,
                     'latitude': List_lat_MX, 'longitude': List_lon_MX})
                df_MX.set_index('Servers DNS', inplace=True)

                html_MX = df_MX.to_html().replace('<th>', '<th style = "color: black">').replace('<td>',
                                                                                                 '<td style = "color: green">')
                c3 = folium.Map(location=[46.078025, 6.409053], zoom_start=2, tiles='Stamen Toner')
                locations_MX = df_MX[['latitude', 'longitude']]
                locationlist_MX = locations_MX.values.tolist()
                max_MX = len(locationlist_MX)  # compté les points associé au coordonnées > gps = 8

                popup_MX = """<html>
                              <head></head>
                              <body><p><span style="color: red">*DNS MX* : </span><span class="macouleur2">{TARGET}</span></p></body>
                              </html>""".format(
                    TARGET=list_ip_MX,
                )

                for item in locationlist_MX:
                    folium.Marker(location=item, popup=popup_MX,
                                  tooltip='<p style="color:#FF0000";>* Informations Servers * click <p>',
                                  icon=folium.features.CustomIcon('smtp.png', icon_size=(30, 30))).add_to(c3)
                    pass

                # legend vue terrain
                folium.TileLayer('Stamen Terrain').add_to(c3)
                folium.TileLayer('Stamen Toner').add_to(c3)
                folium.TileLayer('Stamen Water Color').add_to(c3)
                folium.TileLayer('cartodbpositron').add_to(c3)
                folium.TileLayer('cartodbdark_matter').add_to(c3)
                folium.LayerControl().add_to(c3)

                c3.save('maCarte_GPStest3.html')

                message3 = """<html>
                          <head></head>
                          <center>
                          <p style="color: black;font-size:30px;text-shadow: 1px 1px 1px red,2px 2px 1px red";><span style="text-decoration: underline;"><B>Informations Geolocations Mapping Type Servers MX</B><p>
                          <iframe src=maCarte_GPStest3.html width=1200 height=450></iframe>
                          <center>
                          <center>
                          <img src="smtp.png" width=50 height=50 />
                          </center>
                          <body><p><span class="macouleur2">{geoloc_servers3}</span></p></body>
                          <center>
                          </html>""".format(

                    geoloc_servers3=html_MX,
                )

                bytes3 = message3.encode(encoding='UTF-8')
                f.write(bytes3)
                f.close()
            print(colored("[*] Scanning / Building MAP World Termine with Sucessfull ", 'green'))
            f.close()
            ...
            self.ui.lineEdit.textChanged[str].connect(
                lambda: self.ui.pushButton_2.setEnabled(self.ui.lineEdit.text() != ""))
            print(colored("[*] Scanning and report [Geolocation] finished with Sucessfull ", 'magenta'))
            print(colored("-----------------------------------------------------------------------------------", 'blue'))
            print("")
        else:
            print((colored("[!]|---> [Error DNS no found!]:", "red")), dns1)
    ...
    def Report_DNS_Advanced(self):
        ...
        if verifdns == True:
            self.Dialog_dns.close()
            self.MainWindow.close()
            print(colored("[Welcome on the report [Menu Scanner_DNS_Advanced]  ", 'magenta'))
            print(colored(" [*] <> Building Template HTML ...", "green"))
            ...
            time.sleep(3)
            mpb.update()
            subprocess.call("nmap -sC " + dns + " -oX Extra_Analyse.xml ", shell=True, stdout=subprocess.DEVNULL)
            ...
            print(colored("[*] Scanning and report [Report_DNS_Advanced] finished with Sucessfull ", 'magenta'))
            print(colored("-----------------------------------------------------------------------------------", 'blue'))
            print("")
            text_file.close()
            mGui.destroy()
    ...
    def Report_DNS_Listing_supported_HTTP_methods(self):
        ...
        if verifdns == True:
            ...
            mpb.update()
            subprocess.call(
                "nmap -p80,443 --script http-methods,http-trace --script-args http-methods.test-all=true " + dns + " -oX Extra_Analyse.xml ",
            ...
            text_file.write(message)
            text_file.write(message2)
            print(colored("[*] Scanning and report [DNS_Listing_supported_HTTP_methods] finished with Sucessfull ", 'magenta'))
            print(colored("-----------------------------------------------------------------------------------", 'blue'))
            print("")
            text_file.close()
            mGui.destroy()
    ...
    def Report_DNS_Scraping_Email(self):
        ...
        if verifdns == True:
            ...
            mpb.update()
            subprocess.call(
                "nmap -p80 --script http-grep --script-args http-grep.builtins=e-mail " + dns + " -oX Extra_Analyse.xml ",
                shell=True, stdout=subprocess.DEVNULL)
            subprocess.call("xsltproc Extra_Analyse.xml -o Extra_Analyse.html", shell=True, stdout=subprocess.DEVNULL)
            f = open('Extra_Analyse.html', 'r')
            html_string = f.read()
    ...
    def Report_DNS_SMB(self):
        ...
        if verifdns == True:
            self.Dialog_dns.close()
            self.MainWindow.close()
            print(colored("[Welcome on the report [Report_DNS_SMB] ", 'magenta'))
            print(colored(" [*] <> Building Template HTML ...", "green"))
            print((colored("|--> Starting Analyse DNS Advanced :", 'green')), dns)
            print(colored(" [*] <> [... patient please ...]", "green"))
            self.Dialog_report_champsMX = QtWidgets.QDialog()
            ...
            subprocess.call("nmap --script smb-system-info.nse -p445  " + dns + " -oX  Extra_Analyse.xml ",
                            shell=True, stdout=subprocess.DEVNULL)
            subprocess.call("xsltproc Extra_Analyse.xml -o Extra_Analyse.html", shell=True, stdout=subprocess.DEVNULL)
            f = open('Extra_Analyse.html', 'r')
            html_string = f.read()
            ...
            text_file.write(message)
            text_file.write(message2)
            print(colored("[*] Scanning and report [Report_DNS_SMB] finished with Sucessfull ", 'magenta'))
            print(colored("-----------------------------------------------------------------------------------", 'blue'))
            print("")
            text_file.close()
            mGui.destroy()
    ...
    def Report_DNS_Discovering_interesting(self):
        ...
        if verifdns == True:
            ...
            time.sleep(3)
            mpb.update()
            subprocess.call("nmap --script http-enum -p80  " + dns + " -oX Extra_Analyse.xml  ", shell=True,
            ...
            text_file.write(message)
            text_file.write(message2)
            print(colored("[*] Scanning and report [Report_DNS_Discovering_interesting] finished with Sucessfull ", 'magenta'))
            print(colored("-----------------------------------------------------------------------------------", 'blue'))
            print("")
            text_file.close()
            mGui.destroy()
    ...
    def Report_DNS_mod_userdir(self):
        ...
        if verifdns == True:
            ...
            time.sleep(3)
            mpb.update()
            subprocess.call("nmap -p80 --script http-userdir-enum " + dns + " -oX Extra_Analyse.xml  ", shell=True,
                            stdout=subprocess.DEVNULL)
            subprocess.call("xsltproc Extra_Analyse.xml -o Extra_Analyse.html", shell=True, stdout=subprocess.DEVNULL)
            f = open('Extra_Analyse.html', 'r')
            html_string = f.read()
            ...
            text_file.write(message)
            text_file.write(message2)
            print(colored("[*] Scanning and report [Report_DNS_mod_userdir_enumerate_accounts] finished with Sucessfull ", 'magenta'))
            print(colored("-----------------------------------------------------------------------------------", 'blue'))
            print("")
            text_file.close()
            mGui.destroy()
    ...
    def Report_DNS_Detecting_SMTP(self):
        ...
        if verifdns == True:
            ...
            time.sleep(3)
            mpb.update()
            subprocess.call("nmap -sV --script smtp-open-relay -v " + dns + " -oX Extra_Analyse.xml  ", shell=True,
                            stdout=subprocess.DEVNULL)
            subprocess.call("xsltproc Extra_Analyse.xml -o Extra_Analyse.html", shell=True, stdout=subprocess.DEVNULL)
            f = open('Extra_Analyse.html', 'r')
            html_string = f.read()
            ...
            text_file.write(message)
            text_file.write(message2)
            print(colored("[*] Scanning and report [DNS_Detecting_SMTP_open_relays] finished with Sucessfull ", 'magenta'))
            print(colored("-----------------------------------------------------------------------------------", 'blue'))
            print("")
            text_file.close()
            mGui.destroy()
    ...
    def Report_DNS_Enumeration_SMTP(self):
        ...
        if verifdns == True:
            ...
            time.sleep(3)
            mpb.update()
            subprocess.call("nmap -p25 --script smtp-enum-users" + dns + " -oX Extra_Analyse.xml  ", shell=True,
                            stdout=subprocess.DEVNULL)
            subprocess.call("xsltproc Extra_Analyse.xml -o Extra_Analyse.html", shell=True, stdout=subprocess.DEVNULL)
            f = open('Extra_Analyse.html', 'r')
            html_string = f.read()
            ...
            text_file.write(message)
            text_file.write(message2)
            print(colored("[*] Scanning and report [Report_DNS_Enumeration_SMTP_usernames] finished with Sucessfull ",'magenta'))
            print(colored("-----------------------------------------------------------------------------------", 'blue'))
            print("")
            text_file.close()
            mGui.destroy()
    ...
    def Report_DNS_IMAP(self):
        ...
        if verifdns == True:
            ...
            time.sleep(3)
            mpb.update()
            subprocess.call("nmap -p143,993 --script imap-capabilities " + dns + " -oX Extra_Analyse.xml ",
                            shell=True, stdout=subprocess.DEVNULL)
            subprocess.call("xsltproc Extra_Analyse.xml -o Extra_Analyse.html", shell=True, stdout=subprocess.DEVNULL)
            f = open('Extra_Analyse.html', 'r')
            html_string = f.read()
    ...
    def Report_DNS_POP3(self):
        ...
        if verifdns == True:
            ...
            time.sleep(3)
            mpb.update()
            subprocess.call("nmap -p110 --script pop3-capabilities" + dns + " -oX Extra_Analyse.xml ", shell=True,
                            stdout=subprocess.DEVNULL)
            subprocess.call("xsltproc Extra_Analyse.xml -o Extra_Analyse.html", shell=True, stdout=subprocess.DEVNULL)
            f = open('Extra_Analyse.html', 'r')
            html_string = f.read()
    ...
    def Report_DNS_NTLM(self):
        ...
        if verifdns == True:
            ...
            time.sleep(3)
            mpb.update()
            subprocess.call("nmap -p 25,465,587 --script smtp-ntlm-info " + dns + " -oX Extra_Analyse.xml ",
                            shell=True, stdout=subprocess.DEVNULL)
            subprocess.call("xsltproc Extra_Analyse.xml -o Extra_Analyse.html", shell=True, stdout=subprocess.DEVNULL)
            f = open('Extra_Analyse.html', 'r')
            html_string = f.read()
            ...
            text_file.write(message)
            text_file.write(message2)
            print(colored("[*] Scanning and report [DNS_NTLM_SMTP_authentification] finished with Sucessfull ",'magenta'))
            print(colored("-----------------------------------------------------------------------------------", 'blue'))
            print("")
            text_file.close()
            mGui.destroy()
    ...
    def Report_theharvester(self):
        self.Dialog_dns.close()
        dns = self.ui.lineEdit.text()
        verifdns = (validators.domain(dns))
        if verifdns == True:
            subprocess.call(" theHarvester -d " + dns + " -b all -l 200", shell=True)
        else:
            print((colored("[!]|---> [Error DNS no found!]:", "red")), dns)
            self.Dialog_dns.close()
            self.Dialog_error_dns = QtWidgets.QDialog()
    ...
    def Report_DNS_listall_MYSQL(self):
        ...
        if verifdns == True:
            ...
            time.sleep(3)
            mpb.update()
            subprocess.call("nmap -sV --script=mysql-databases " + dns + " -oX Extra_Analyse.xml ", shell=True,
                            stdout=subprocess.DEVNULL)
            subprocess.call("xsltproc Extra_Analyse.xml -o Extra_Analyse.html", shell=True, stdout=subprocess.DEVNULL)
            f = open('Extra_Analyse.html', 'r')
            html_string = f.read()
    ...
    def Report_DNS_Empty_MYSQL(self):
        ...
        if verifdns == True:
            ...
            time.sleep(3)
            mpb.update()
            subprocess.call("nmap -p3306 --script mysql-empty-password " + dns + " -oX Extra_Analyse.xml ",
                            shell=True, stdout=subprocess.DEVNULL)
            subprocess.call("xsltproc Extra_Analyse.xml -o Extra_Analyse.html", shell=True, stdout=subprocess.DEVNULL)
            f = open('Extra_Analyse.html', 'r')
            html_string = f.read()
    ...
    def Report_DNS_info_mssql(self):
        ...
        self.Dialog_dns.close()
        dns = self.ui.lineEdit.text()
        verifdns = subprocess.call(['ping', '-c', '1', dns], stdout=subprocess.DEVNULL, stderr=subprocess.STDOUT)
        if verifdns == 0:
            self.Dialog_dns.close()
            self.MainWindow.close()
            ...
            time.sleep(3)
            mpb.update()
            subprocess.call("nmap -p1433 --script ms-sql-info " + dns + " -oX Extra_Analyse.xml ", shell=True,
                            stdout=subprocess.DEVNULL)
            subprocess.call("xsltproc Extra_Analyse.xml -o Extra_Analyse.html", shell=True, stdout=subprocess.DEVNULL)
            f = open('Extra_Analyse.html', 'r')
            html_string = f.read()
    ...
    def Report_DNS_info_mongodb(self):
        ...
        if verifdns == True:
            ...
            time.sleep(3)
            mpb.update()
            subprocess.call("nmap -p27017 --script mongodb-info " + dns + " -oX Extra_Analyse.xml ", shell=True,
                            stdout=subprocess.DEVNULL)
            subprocess.call("xsltproc Extra_Analyse.xml -o Extra_Analyse.html", shell=True, stdout=subprocess.DEVNULL)
            f = open('Extra_Analyse.html', 'r')
            html_string = f.read()
    ...
    def Report_DNS_detecting_mongodb(self):
        ...
        if verifdns == True:
            ...
            subprocess.call("nmap -p27017 --script mongodb-databases " + dns + " -oX Extra_Analyse.xml", shell=True,
                            stdout=subprocess.DEVNULL)
            subprocess.call("xsltproc Extra_Analyse.xml -o Extra_Analyse.html", shell=True, stdout=subprocess.DEVNULL)
            f = open('Extra_Analyse.html', 'r')
            html_string = f.read()
    ...
    def Report_DNS_List_CoucheDB(self):
        ...
        if verifdns == True:
            ...
            time.sleep(3)
            mpb.update()
            subprocess.call("nmap -p5984 --script couchdb-databases " + dns + " -oX Extra_Analyse.xml", shell=True,
                            stdout=subprocess.DEVNULL)
            subprocess.call("xsltproc Extra_Analyse.xml -o Extra_Analyse.html", shell=True, stdout=subprocess.DEVNULL)
            f = open('Extra_Analyse.html', 'r')
            html_string = f.read()
    ...
    def Report_DNS_CoucheDB_static(self):
        ...
        if verifdns == True:
            ...
            time.sleep(3)
            mpb.update()
            subprocess.call("nmap -p5984 --script couchdb-stats " + dns + " -oX Extra_Analyse.xml ", shell=True,
                            stdout=subprocess.DEVNULL)
            subprocess.call("xsltproc Extra_Analyse.xml -o Extra_Analyse.html", shell=True, stdout=subprocess.DEVNULL)
            f = open('Extra_Analyse.html', 'r')
            html_string = f.read()
    ...
    def Report_CVE_Scan(self):
        ...
        if verifdns == True:
            ...
            time.sleep(3)
            mpb.update()
            subprocess.call("nmap -sV --script=vulners " + dns + " -oX Extra_Analyse.xml ", shell=True,
                            stdout=subprocess.DEVNULL)
            subprocess.call("xsltproc Extra_Analyse.xml -o Extra_Analyse.html", shell=True, stdout=subprocess.DEVNULL)
            f = open('Extra_Analyse.html', 'r')
            html_string = f.read()
    ...
    def Report_XSS_Scan(self):
        ...
        if verifdns == True:
            ...
            time.sleep(3)
            mpb.update()
            subprocess.call("nmap -p80 --script http-unsafe-output-escaping " + dns + " -oX Extra_Analyse.xml ",
                            shell=True, stdout=subprocess.DEVNULL)
            subprocess.call("xsltproc Extra_Analyse.xml -o Extra_Analyse.html", shell=True, stdout=subprocess.DEVNULL)
            f = open('Extra_Analyse.html', 'r')
            html_string = f.read()
    ...
    def Report_SQL_Scan(self):
        ...
        if verifdns == True:
            ...
            subprocess.call("nmap -p80 --script http-sql-injection " + dns + " -oX Extra_Analyse.xml ", shell=True,
                            stdout=subprocess.DEVNULL)
            subprocess.call("xsltproc Extra_Analyse.xml -o Extra_Analyse.html", shell=True, stdout=subprocess.DEVNULL)
            f = open('Extra_Analyse.html', 'r')
            html_string = f.read()
    ...
    def Report_DDOS(self):
        ...
        if verifdns == True:
            ...
            self.ui = Ui_Dialog_report_champsMX()
            self.ui.setupUi(self.Dialog_report_champsMX)
            print(colored("[Welcome on the report [DNS_DDOS] ", 'magenta'))
            print(colored(" [*] <> Building Template HTML ...", "green"))
            print((colored("|--> Starting Analyse DNS Advanced :", 'green')), dns)
            print(colored(" [*] <> [... patient please ...]", "green"))
            mGui = Tk()
            ...
            mpb.update()
            subprocess.call(
                "nmap -p80 --script http-slowloris --max-parallelism 400" + dns + " -oX Extra_Analyse.xml ",
                shell=True, stdout=subprocess.DEVNULL)
            mpb["value"] = 50
            time.sleep(3)
            mpb.update()
            ...
            text_file.write(message)
            text_file.write(message2)
            print(colored("[*] Scanning and report [DNS_DDOS] finished with Sucessfull ",'magenta'))
            print(colored("-----------------------------------------------------------------------------------", 'blue'))
            print("")
            text_file.close()
            mGui.destroy()
    ...
    def Report_web_applications_Scan(self):
        ...
        if verifdns == True:
            ...
            time.sleep(2)
            mpb.update()
            subprocess.call("nmap -p80 --script http-default-accounts " + dns + " -oX Extra_Analyse.xml ",
                            shell=True, stdout=subprocess.DEVNULL)
            mpb["value"] = 50
            time.sleep(3)
            mpb.update()
    ...
    def Report_Shellshock_Scan(self):
        ...
        if verifdns == True:
            ...
            time.sleep(3)
            mpb.update()
            subprocess.call("nmap -sV --script http-shellshock " + dns + " -oX Extra_Analyse.xml ", shell=True,
                            stdout=subprocess.DEVNULL)
            subprocess.call("xsltproc Extra_Analyse.xml -o Extra_Analyse.html", shell=True, stdout=subprocess.DEVNULL)
            f = open('Extra_Analyse.html', 'r')
            html_string = f.read()
    ...
    def Report_insecure_crossdomain_Scan(self):
        ...
        if verifdns == True:
            ...
            subprocess.call("nmap --script http-cross-domain-policy  " + dns + " -oX Extra_Analyse.xml ", shell=True,
                            stdout=subprocess.DEVNULL)
            subprocess.call("xsltproc Extra_Analyse.xml -o Extra_Analyse.html", shell=True, stdout=subprocess.DEVNULL)
            f = open('Extra_Analyse.html', 'r')
            html_string = f.read()
            ...
            text_file.write(message)
            text_file.write(message2)
            print(colored("[*] Scanning and report [DNS_insecure_crossdomain_Scan]] finished with Sucessfull ",'magenta'))
            print(colored("-----------------------------------------------------------------------------------", 'blue'))
            print("")
            text_file.close()
            mGui.destroy()
    ...
    def Report_sourcecode_control_Scan(self):
        ...
        if verifdns == True:
            ...
            time.sleep(3)
            mpb.update()
            subprocess.call("nmap -p80 --script http-git " + dns + " -oX Extra_Analyse.xml ", shell=True,
                            stdout=subprocess.DEVNULL)
            subprocess.call("xsltproc Extra_Analyse.xml -o Extra_Analyse.html", shell=True, stdout=subprocess.DEVNULL)
            f = open('Extra_Analyse.html', 'r')
            html_string = f.read()
    ...
    def Report_InsecureCipherSSL(self):
        ...
        if verifdns == True:
            ...
            subprocess.call("nmap --script ssl-enum-ciphers -p 443 " + dns + " -oX Extra_Analyse.xml", shell=True,
                            stdout=subprocess.DEVNULL)
            subprocess.call("xsltproc Extra_Analyse.xml -o Extra_Analyse.html", shell=True, stdout=subprocess.DEVNULL)
            f = open('Extra_Analyse.html', 'r')
            html_string = f.read()
    ...
    def Report_CSRF(self):
        ...
        if verifdns == True:
            ...
            time.sleep(3)
            mpb.update()
            subprocess.call("nmap -p80 --script http-csrf " + dns + " -oX Extra_Analyse.xml ", shell=True,
                            stdout=subprocess.DEVNULL)
            subprocess.call("xsltproc Extra_Analyse.xml -o Extra_Analyse.html", shell=True, stdout=subprocess.DEVNULL)
            f = open('Extra_Analyse.html', 'r')
            html_string = f.read()
    ...
    def Report_SMB_vulnerabilitie(self):
        ...
        if verifdns == True:
            ...
            time.sleep(3)
            mpb.update()
            subprocess.call("nmap --script smb-check-vulns.nse -p445 " + dns + " -oX Extra_Analyse.xml ", shell=True,
                            stdout=subprocess.DEVNULL)
            subprocess.call("xsltproc Extra_Analyse.xml -o Extra_Analyse.html", shell=True, stdout=subprocess.DEVNULL)
            f = open('Extra_Analyse.html', 'r')
            html_string = f.read()
    ...
    def Report_SSL_Injection(self):
        ...
        if verifdns == True:
            ...
            subprocess.call("nmap -p 443 --script ssl-ccs-injection " + dns + " -oX Extra_Analyse.xml  ", shell=True,
                            stdout=subprocess.DEVNULL)
            subprocess.call("xsltproc Extra_Analyse.xml -o Extra_Analyse.html", shell=True, stdout=subprocess.DEVNULL)
            f = open('Extra_Analyse.html', 'r')
            html_string = f.read()
    ...
    def Report_HTTP_WAF(self):
        ...
        if verifdns == True:
            ...
            time.sleep(3)
            mpb.update()
            subprocess.call("nmap -p80 --script http-waf-detect " + dns + " -oX Extra_Analyse.xml ", shell=True,
                            stdout=subprocess.DEVNULL)
            subprocess.call("xsltproc Extra_Analyse.xml -o Extra_Analyse.html", shell=True, stdout=subprocess.DEVNULL)
            f = open('Extra_Analyse.html', 'r')
            html_string = f.read()
    ...
    def Report_Fingerprint_WAF(self):
        ...
        if verifdns == True:
            ...
            time.sleep(3)
            mpb.update()
            subprocess.call("nmap --script=http-waf-fingerprint " + dns + " -oX Extra_Analyse.xml  ", shell=True,
                            stdout=subprocess.DEVNULL)
            subprocess.call("xsltproc Extra_Analyse.xml -o Extra_Analyse.html", shell=True, stdout=subprocess.DEVNULL)
            f = open('Extra_Analyse.html', 'r')
            html_string = f.read()
        ...
        if verifdns == True:
            def scanner_admin_php():
                ...
                php = ['admin/', 'administrator/', 'admin1/', 'admin2/', 'admin3/', 'admin4/', 'admin5/', 'usuarios/',
                       ...
                       'admin.php','admin.html', 'index.php', 'login.php', 'login.html', 'administrator', 'admin', 'adminpanel',
                       'cpanel', 'login', 'wp-login.php', 'administrator', 'admins', 'logins', 'admin.asp', 'login.asp',
                       'adm/', 'admin/', 'admin/account.html','admin/login.html','admin/login.html','admin/controlpanel.html',
                       'admin/controlpanel.htm','admin/adminLogin.html','admin/adminLogin.htm',
                       'admin.htm','admin.html','adminitem/','adminitems/','administrator/','administrator/login.%EXT%','administrator.%EXT%','administration/',
                       'administration.%EXT%','adminLogin/','adminlogin.%EXT%','admin_area/admin.%EXT%','admin_area/','admin_area/login.%EXT%','manager/','superuser/',
                       'superuser.%EXT%','access/','access.%EXT%','sysadm/','sysadm.%EXT%','superman/','supervisor/','panel.%EXT%','control/','control.%EXT%',
                       'member/','member.%EXT%','members/','user/','user.%EXT%','cp/','uvpanel/','manage/','manage.%EXT%','management/','management.%EXT%','signin/','signin.%EXT%','log-in/','log-in.%EXT%','log_in/','log_in.%EXT%',
                       'sign_in/','sign_in.%EXT%','sign-in/','sign-in.%EXT%','users/','users.%EXT%','accounts/','accounts.%EXT%','bb-admin/login.%EXT%',
                       'bb-admin/admin.%EXT%','bb-admin/admin.html','administrator/account.%EXT%','relogin.htm','relogin.html','check.%EXT%','relogin.%EXT%','blog/wp-login.%EXT%',
                       'user/admin.%EXT%','users/admin.%EXT%','registration/','processlogin.%EXT%','checklogin.%EXT%','checkuser.%EXT%','checkadmin.%EXT%','isadmin.%EXT%','authenticate.%EXT%','authentication.%EXT%',
                       'auth.%EXT%','authuser.%EXT%','authadmin.%EXT%','cp.%EXT%','modelsearch/login.%EXT%','moderator.%EXT%','moderator/','controlpanel/','controlpanel.%EXT%',
                       'admincontrol.%EXT%','adminpanel.%EXT%','fileadmin/','fileadmin.%EXT%','sysadmin.%EXT%','admin1.%EXT%','admin1.html','admin1.htm','admin2.%EXT%',
                       'admin2.html','yonetim.%EXT%','yonetim.html','yonetici.%EXT%','yonetici.html','phpmyadmin/','myadmin/',
                       'ur-admin.%EXT%','ur-admin/','Server.%EXT%','Server/','wp-admin/','administr8.%EXT%','administr8/','webadmin/','webadmin.%EXT%','administratie/',
                       'admins/','admins.%EXT%','administrivia/','Database_Administration/','useradmin/','sysadmins/','sysadmins/','admin1/',
                       'system-administration/','administrators/','pgadmin/','directadmin/','staradmin/','ServerAdministrator/','SysAdmin/','administer/','LiveUser_Admin/',
                       'sys-admin/','typo3/','panel/','cpanel_file/','platz_login/','rcLogin/','blogindex/','formslogin/','autologin/','manuallogin/','simpleLogin/','loginflat/',
                       'utility_login/','showlogin/','memlogin/','login-redirect/','sub-login/','wp-login/','login1/','dir-login/','login_db/', 'xlogin/',
                       'smblogin/','customer_login/','UserLogin/','login-us/','acct_login/','bigadmin/','project-admins/','phppgadmin/','pureadmin/','sql-admin/',
                       'radmind/','openvpnadmin/','wizmysqladmin/','vadmind/','ezsqliteadmin/','hpwebjetadmin/','newsadmin/','adminpro/','Lotus_Domino_Admin/','bbadmin/','vmailadmin/',
                       'Indy_admin/','ccp14admin/','irc-macadmin/','banneradmin/','sshadmin/','phpldapadmin/','macadmin/','administratoraccounts/','admin4_account/','admin4_colon/',
                       'radmind-1/','Super-Admin/','AdminTools/','cmsadmin/','SysAdmin2/','globes_admin/','cadmins/','phpSQLiteAdmin/','navSiteAdmin/','server_admin_small/','logo_sysadmin/','system_administration/',
                       'ss_vms_admin_sm/','bb-admin/','panel-administracion/','instadmin/','memberadmin/','administratorlogin/','adm.%EXT%','admin_login.%EXT%',
                       'panel-administracion/login.%EXT%','pages/admin/admin-login.%EXT%','pages/admin/','acceso.%EXT%','admincp/login.%EXT%','admincp/','adminarea/','admincontrol/',
                       'affiliate.%EXT%','adm_auth.%EXT%','memberadmin.%EXT%','administratorlogin.%EXT%','modules/admin/','administrators.%EXT%','siteadmin/',
                       'siteadmin.%EXT%','adminsite/','kpanel/','vorod/','vorod.%EXT%','vorud/','vorud.%EXT%','adminpanel/','PSUser/','secure/','webmaster/','webmaster.%EXT%','autologin.%EXT%',
                       'userlogin.%EXT%','admin_area.%EXT%','cmsadmin.%EXT%','security/','usr/','root/','secret/','admin/login.%EXT%','admin/adminLogin.%EXT%','moderator.php',
                       'moderator.html','moderator/login.%EXT%','moderator/admin.%EXT%','yonetici.%EXT%','0admin/','0manager/','aadmin/','cgi-bin/login%EXT%','login1%EXT%',
                       'login_admin/','login_admin%EXT%','login_out/','login_out%EXT%','login_user%EXT%','loginerror/','loginok/', 'loginsave/','loginsuper/','loginsuper%EXT%',
                       'login%EXT%','logout/','logout%EXT%','secrets/','super1/','super1%EXT%','super_index%EXT%','super_login%EXT%','supermanager%EXT%','superman%EXT%',
                       'superuser%EXT%','supervise/','supervise/Login%EXT%','super%EXT%','admin/login.php','admin/admin.php', 'admin/account.php','admin_area/admin.php', 'admin_area/login.php', 'siteadmin/login.php', 'siteadmin/index.php',
                       'siteadmin/login.html', 'admin/account.html', 'admin/index.html', 'admin/login.html','admin/admin.html', 'admin_area/index.php', 'bb-admin/index.php', 'bb-admin/login.php',
                       'bb-admin/admin.php','admin/home.php','admin_area/login.html', 'admin_area/index.html','admin/controlpanel.php', 'admin.php', 'admincp/index.asp', 'admincp/login.asp',
                       'admincp/index.html','admin/account.html', 'adminpanel.html', 'webadmin.html','webadmin/index.html', 'webadmin/admin.html', 'webadmin/login.html', 'admin/admin_login.html',
                       'admin_login.html', 'panel-administracion/login.html','admin/cp.php', 'cp.php', 'administrator/index.php', 'administrator/login.php','nsw/admin/login.php', 'webadmin/login.php', 'admin/admin_login.php', 'admin_login.php',
                       'administrator/account.php', 'administrator.php', 'admin_area/admin.html','pages/admin/admin-login.ph','admin/admin-login.php', 'admin-login.php',
                       ...
                       'admincontrol/login.html', 'adm/index.html', 'adm.html', 'moderator/admin.html', 'user.php','account.html','controlpanel.html', 'admincontrol.html','panel-administracion/login.php', 'wp-login.php', 'adminLogin.php', 'admin/adminLogin.php',
                       'home.php', 'admin.php', 'adminarea/index.php','adminarea/admin.php', 'adminarea/login.php', 'panel-administracion/index.php','panel-administracion/admin.php', 'modelsearch/index.php',
                ...
                print(dfwhois)
                htmlwhois = dfwhois.to_html(justify="center", border=1).replace('<th>','<th style = "color: red">').replace(
                    '<td>', '<td style = "color: white">')
                dfwhois2 = pd.DataFrame({'page200': list_200})
                htmlwhois2 = dfwhois2.to_html(justify="center", border=1).replace('<th>','<th style = "color: green">').replace(
                    '<td>', '<td style = "color: white">')
